...
def create_docs_app(
    ...
    """Create Docs application."""
    resolved_config = config or ServiceConfig.from_env('docs')
    docs_extension = DocsExtension(resolved_config)
    return create_service_app(
        resolved_config,
        extensions=(docs_extension, *extensions),
    )
